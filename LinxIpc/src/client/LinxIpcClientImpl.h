...
class LinxIpcClientImpl : public std::enable_shared_from_this<LinxIpcClientImpl>, public LinxIpcClient {
  public:
    LinxIpcClientImpl(const LinxIpcServerPtr &server, const std::string &serviceName);
    ~LinxIpcClientImpl() {}
